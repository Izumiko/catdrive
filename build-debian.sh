...
deb [arch=arm64] http://mirrors.tuna.tsinghua.edu.cn/debian/ ${os_ver} main
deb [arch=arm64] http://mirrors.tuna.tsinghua.edu.cn/debian/ ${os_ver}-updates main
deb [arch=arm64] http://mirrors.tuna.tsinghua.edu.cn/debian-security/ ${os_ver}-security main
deb [arch=arm64] http://mirrors.tuna.tsinghua.edu.cn/debian/ ${os_ver}-backports main contrib non-free
